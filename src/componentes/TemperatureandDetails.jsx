    ...
    return (
        <div>
            ...
            <div className='flex flex-row items-center justify-between text-white py-3'>
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Eo_circle_orange_blank.svg/768px-Eo_circle_orange_blank.svg.png" style={{ width: 93 }} alt='' className='w-20' />
                {/* <img src={iconUrlFromCode(icons)} alt='' className='w-20'/> */}
            ...
            <div className='flex flex-row items-center justify-between space-x-2 text-white text-sm py-3'>
                <UilSun />
                ...
                <UilSun />
                <p className='font-light'>
                    High: <span className='font-medium ml- 3'>{`${temp_max.toFixed()}°`}</span>
                </p>
                <p className='font-ligth'>|</p>
